...
There are related html options for this purpose. More information can be found in the [official guide](https://quarto.org/docs/websites/website-navigation.html#github-links).

## Customize 404 Page

You can create your own page for handling 404 error. In many cases a `404.qmd` file is all what you need. More information can be found in the [official guide](https://quarto.org/docs/websites/website-navigation.html#pages-404).
