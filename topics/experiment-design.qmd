...
![CRD v.s. RCBD explained using Petri dishes in a fridge (screenshot from the workshop)](/img/CRD-vs-RCBD.png)
...
![RCBD design on a football pitch (screenshot from the workshop)](/img/RCBD-football-pitch.png)
...
![two-way-RCBD-scenarios](/img/two-way-RCBD-scenarios.png)
